...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        exit->setIcon(icon1);
        QFont font;
        font.setFamilies(QStringList{QString::fromUtf8("MS Shell Dlg 2")});
        ...
        QFont font1;
        font1.setFamilies(QStringList{QString::fromUtf8("MS Shell Dlg 2")});
        ...
        QFont font2;
        font2.setFamilies(QStringList{QString::fromUtf8("MS Sans Serif")});
        ...
        menu_6->addAction(words);
        menu_6->addAction(sentences);
