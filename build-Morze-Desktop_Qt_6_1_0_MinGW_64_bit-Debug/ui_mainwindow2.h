...
public:
    ...
    void setupUi(QMainWindow *MainWindow2)
    {
        ...
        layoutWidget1->setGeometry(QRect(10, 0, 219, 31));
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("../Qt/Morze_/Morze/img/sound-512.png"), QSize(), QIcon::Normal, QIcon::Off);
        Replay->setIcon(icon4);

        horizontalLayout_4->addWidget(Replay);

        NewChar = new QPushButton(layoutWidget1);
        NewChar->setObjectName(QString::fromUtf8("NewChar"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8("../Qt/Morze_/Morze/img/change.png"), QSize(), QIcon::Normal, QIcon::Off);
        NewChar->setIcon(icon5);

        horizontalLayout_4->addWidget(NewChar);
        ...
        layoutWidget3->setGeometry(QRect(330, 130, 135, 53));
        verticalLayout_8 = new QVBoxLayout(layoutWidget3);
        verticalLayout_8->setObjectName(QString::fromUtf8("verticalLayout_8"));
        verticalLayout_8->setContentsMargins(0, 0, 0, 0);
        LANGUAGE = new QLineEdit(layoutWidget3);
        LANGUAGE->setObjectName(QString::fromUtf8("LANGUAGE"));

        verticalLayout_8->addWidget(LANGUAGE);
    ...
    void retranslateUi(QMainWindow *MainWindow2)
    {
        ...
        Replay->setText(QCoreApplication::translate("MainWindow2", "Replay", nullptr));
#if QT_CONFIG(shortcut)
        Replay->setShortcut(QCoreApplication::translate("MainWindow2", "Ctrl+P", nullptr));
#endif // QT_CONFIG(shortcut)
        NewChar->setText(QCoreApplication::translate("MainWindow2", "\320\235\320\276\320\262\321\213\320\271 \321\201\320\270\320\274\320\262\320\276\320\273", nullptr));
#if QT_CONFIG(shortcut)
        NewChar->setShortcut(QCoreApplication::translate("MainWindow2", "Ctrl+R", nullptr));
#endif // QT_CONFIG(shortcut)
